// main_script.js - Script principal actualizado para trabajar con content.js
...
// === Inicializar búsqueda y filtros después de que se renderice el contenido ===
function initializeSearchAndFilters() {
    ...
    // Filtros - usar delegación de eventos ya que los botones se crean dinámicamente
...
// === Inicializar funcionalidad del botón de email después de renderizar ===
...
function initializeTypingEffect() {
    ...
    if(h1 && typeof portfolioContent !== 'undefined'){
        const titleText = portfolioContent.header.title;
        h1.textContent = ''; // Limpiar el contenido inicial
        let charIndex = 0;
        const typeWriter = () => {
...
document.addEventListener('DOMContentLoaded', () => {
    // Esperar un momento para asegurar que render.js haya terminado
    setTimeout(() => {
